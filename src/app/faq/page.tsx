...
const faqs = [
  {
    ...
    answer:
      "AI асистентът е софтуер с изкуствен интелект, който работи на вашия компютър или виртуална машина. Той може да ви помага с писане на текстове, анализ на документи, отговаряне на въпроси, автоматизация на задачи и много повече — 24 часа в денонощието, 7 дни в седмицата.",
  },
  {
    question: "Защо ми е нужна професионална настройка?",
    answer:
      "Софтуерът е с отворен код и безплатен, но инсталацията и конфигурацията изискват сериозни технически познания — от работа с командния ред до настройка на сигурност и мрежови конфигурации. Неправилната настройка може да доведе до проблеми със сигурността или лоша производителност. Ние се грижим всичко да работи перфектно.",
  },
  {
    question: "Колко време отнема инсталацията?",
    answer:
      "Стандартната инсталация и настройка отнема между 2-4 часа в зависимост от вашите нужди и конфигурация. След това тестваме всичко и ви обучаваме как да го използвате.",
  },
  {
  ...
  {
    question: "Какво представлява Discord абонаментът?",
    answer:
      "Нашата Discord общност е място, където всички наши клиенти могат да споделят идеи, да получат помощ, да задават въпроси и да създават тикети за поддръжка. Имате достъп до експерти и общност от хора, които също използват AI асистенти.",
  },
  {
    question: "Мога ли да получа безплатен пробен период?",
    answer:
      "Да! При поръчка на еднократна настройка (200 лв) получавате 1 месец безплатен достъп до нашата Discord общност. Така можете да опитате поддръжката преди да решите дали да продължите с абонамент.",
  },
  {
    question: "Как да платя?",
    answer:
      "Приемаме плащания с банкова карта и Revolut. Процесът е прост: свързвате се с нас, обсъждаме вашите нужди, съгласяваме се и извършвате плащането.",
  },
  {
